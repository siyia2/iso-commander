...
SRC_FILES = isocmd/main_general.cpp isocmd/cache.cpp isocmd/filtering.cpp isocmd/mount.cpp isocmd/umount.cpp isocmd/cp_mv_rm.cpp conversion_tools/conversion_tools.cpp
