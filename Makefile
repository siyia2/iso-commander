...
SRC_FILES = isocmd/main.cpp isocmd/history.cpp  isocmd/general.cpp  isocmd/verbose.cpp isocmd/cache.cpp isocmd/filtering.cpp isocmd/mount.cpp isocmd/umount.cpp isocmd/cp_mv_rm.cpp isocmd/conversion_tools.cpp
