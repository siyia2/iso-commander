...
int main() {
    ...
    while (!exitProgram) {
        ...
        char* input = readline("Enter a choice: ");
		    ...
		    std::system("clear");
                ...
                case '4':
                    while (!returnToMainMenu) {
                        ...
                        char* submenu_input = readline("Enter a choice: ");
...
void select_and_convert_files_to_iso() {
    ...
    if (binImgFiles.empty()) {
        ...
        while (true) {
            std::cout << "\033[31mChoose a file to process (enter the number or range e.g., 1-5 or 1 or simply press Enter to return):\033[0m ";
            std::getline(std::cin, input);
