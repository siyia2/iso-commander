        ...
        if (std::isspace(input[0]) || input[0] == '\0') {
			...
			if (strcmp(input, "/") == 0) { // Check if the input is "/"
				...
				// Prompt for BIN/IMG files
					prompt = "\n\001\033[1;92m\002Term(s)\001\033[1;94m\002 ↵ to filter \001\033[1;38;5;208m\002BIN/IMG\001\033[1;94m\002 list (ccase-insensitive, multi-term separator: \001\033[1;93m\002;\001\033[1;94m\002), or ↵ to return: \001\033[0;1m\002";
				} else if (fileType == "mdf") {
