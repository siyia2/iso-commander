...
void processInputForCpMvRm(const std::string& input, const std::vector<std::string>& globalIsoFileList, const std::string& process, std::unordered_set<std::string>& operationIsos, std::unordered_set<std::string>& operationErrors, std::unordered_set<std::string>& uniqueErrorMessages, bool& umountMvRmBreak, bool& filterHistory, bool& verbose, std::atomic<bool>& newISOFound);
...
void tokenizeInput(const std::string& input, const std::vector<std::string>& globalIsoFileList, std::unordered_set<std::string>& uniqueErrorMessages, std::unordered_set<int>& processedIndices);
...
//------------------
void mountIsoFiles(const std::vector<std::string>& globalIsoFileList, std::unordered_set<std::string>& mountedFiles, std::unordered_set<std::string>& skippedMessages, std::unordered_set<std::string>& mountedFails, std::atomic<size_t>* completedTasks, std::atomic<size_t>* failedTasks, bool silentMode);
...
void traverse(const std::filesystem::path& path, std::vector<std::string>& globalIsoFileList, std::unordered_set<std::string>& uniqueErrorMessages, std::atomic<size_t>& totalFiles, std::mutex& traverseFilesMutex, std::mutex& traverseErrorsMutex, int& maxDepth, bool& promptFlag);
...
void handleIsoFileOperation(const std::vector<std::string>& globalIsoFileList, const std::vector<std::string>& globalIsoFileListCopy, std::unordered_set<std::string>& operationIsos, std::unordered_set<std::string>& operationErrors, const std::string& userDestDir, bool isMove, bool isCopy, bool isDelete, std::atomic<size_t>* completedBytes, std::atomic<size_t>* completedTasks, std::atomic<size_t>* failedTasks, bool overwriteExisting);
...
void writeToUsb(const std::string& input, const std::vector<std::string>& globalIsoFileList, std::unordered_set<std::string>& uniqueErrorMessages);
...
std::string userDestDirRm(const std::vector<std::string>& globalIsoFileList, std::vector<std::vector<int>>& indexChunks, std::unordered_set<std::string>& uniqueErrorMessages, std::string& userDestDir, std::string& operationColor, std::string& operationDescription, bool& umountMvRmBreak, bool& filterHistory, bool& isDelete, bool& isCopy, bool& abortDel, bool& overwriteExisting);
