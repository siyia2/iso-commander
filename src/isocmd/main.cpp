...
void saveAutomaticImportConfig(const std::string& filePath) {
    ...
    while (true) {
        clearScrollBuffer();
        std::string prompt = "\001\033[0;1m\002Automatically updates ISO cache in the background by scanning all stored folder paths from readline history (up to 25).\n"
                             ...
                             "\n\n\001\033[1;94m\002Toggle automatic background ISO updates on every startup (\001\033[1;92m\0021\001\033[1;94m\002/\001\033[1;91m\0020\001\033[1;94m\002), or \001\033[1;93m\002anyKey\001\033[1;94m\002 ↵ to return: \001\033[0;1m\002";
