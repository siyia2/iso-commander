...
void performDeleteOperation(const fs::path& srcPath, const std::string& srcDir, const std::string& srcFile, size_t fileSize,
    ...
    if (!g_operationCancelled.load()) {
        ...
        if (fs::remove(srcPath, ec)) {
            ...
            verboseIsos.push_back("\033[0;1mDeleted: \033[1;92m'" + (!displayConfig::toggleNamesOnly ? srcDir + "/" : "") + srcFile + "'\033[0;1m.");
        ...
        verboseErrors.push_back("\033[1;91mError deleting: \033[1;93m'" + (!displayConfig::toggleNamesOnly ? srcDir + "/" : "") + srcFile + "'\033[1;91m: " +
