...
void manualRefreshCache(const std::string& initialDir) {
	...
	if (!initialDir.empty()) {
		...
		std::string prompt = "\001\033[1;94m\002Directory path(s) ↵ to import \001\033[1;92m\002ISO\001\033[1;94m\002 file(s) into the \001\033[1;92m\002Cache\001\033[94m\002 (multi-path separator: \001\033[1m\002\001\033[1;93m\002;\001\033[1;94m\002), or ↵ to return:\n\001\033[0;1m\002";
