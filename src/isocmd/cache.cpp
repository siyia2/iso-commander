...
void manualRefreshCache(const std::string& initialDir) {
	...
	if (!initialDir.empty()) {
		...
		std::string prompt = "\n\001\033[1;92m\002Directory path(s)\001\033[1;94m\002 ↵ to scan for and import \001\033[1;92m\002.iso\001\033[1;94m\002 files into \001\033[1;92m\002on-disk\001\033[1;94m\002 cache (multi-path separator: \001\033[1m\002\001\033[1;93m\002;\001\033[1;94m\002), or ↵ to return:\n\001\033[0;1m\002";
