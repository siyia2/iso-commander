...
void helpSearches(bool isCpMv, bool import2ISO) {
    ...
    if (!isCpMv) {
       ...
       std::cout << "\033[1;32m" << "5. Special Configuration Commands:\033[0m\n\n";
		...
		std::cout << "   \033[1;38;5;208mA. Set Max Entries Per Page (Default: 25):\033[0m\n"
		...
		if (import2ISO) { 
			std::cout << "   \033[1;38;5;208mC. Auto-Import ISO:\033[0m\n"
            << "      • Enter \033[1;35m'*auto_on'\033[0m or \033[1;35m'*auto_off'\033[0m - Enable/Disable automatic ISO import from stored folder paths (default: disabled)\n\n";
		}
    }
