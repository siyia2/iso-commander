...
void helpSearches(bool isCpMv, bool import2ISO) {
    ...
    if (!isCpMv) {
       ...
       std::cout << "\033[1;32m" << "5. Special Configuration Commands:\033[0m\n\n";
		...
		if (import2ISO) { 
			std::cout << "   \033[1;38;5;208mA. Auto-Update ISO Database:\033[0m\n"
		...
		std::cout << "   \033[1;38;5;208mB. Set Max Entries Per Page (Default: 25):\033[0m\n"
          << "      • Enter '*pagination_{number}' (e.g., 'pagination_50')\n"
          << "      • Disable: {number} <= 0 (e.g., 'pagination_-1' or 'pagination_0')\n"  << std::endl;
                     
		std::cout << "\033[1;38;5;208m   C. Set Default Display Modes (fl = full list, cl = compact list | default: cl, unmount → fl):\033[0m\n"
