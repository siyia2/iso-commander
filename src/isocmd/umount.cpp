...
void handleFiltering(bool& isFiltered, std::vector<std::string>& filteredIsoDirs, const std::vector<std::string>& isoDirs, bool& clr) {
...
void unmountIsoDirs(
    const std::vector<std::string>& selectedIsoDirs, 
    std::set<std::string>& unmountedFiles,  // Keep this as vector
    std::set<std::string>& unmountedErrors, // Keep this as vector
    ...
    bool& verbose) 
{
    ...
    // Assuming displayProgressBar is defined elsewhere
...
void unmountISOs(bool& historyPattern, bool& verbose) {
    ...
    while (true) {
        ...
        if (inputString.empty()) {
            ...
            handleFiltering(isFiltered, filteredIsoDirs, isoDirs, clr);
        } else {
