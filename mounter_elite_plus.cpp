...
void manualRefreshCache() {
    ...
    std::string inputLine = readInputLine("\033[94mEnter directory paths to manually refresh the cache (separated by semicolons), or simply press enter to cancel:\033[0m ");
