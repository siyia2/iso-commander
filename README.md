...
It is recommended that directories that are to be searched should have permissions of `755` and upwards for better list generation, but if not, you can set it up as an `SUID`, or you can always run it as `ROOT` from the beginning if need be.
