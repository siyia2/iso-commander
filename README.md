...
It is recommended that directories that are to be searched should have permissions of 750 and upwards for better list generations, but if not, you can always run it as ROOT from the beginning if need be.
